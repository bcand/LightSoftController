...
class _objref_ManagedElementIterator_I (CORBA.Object):
    ...
    def next_n(self, *args):
        return self._obj.invoke("next_n", _0_managedElement.ManagedElementIterator_I._d_next_n, args)

    def getLength(self, *args):
        return self._obj.invoke("getLength", _0_managedElement.ManagedElementIterator_I._d_getLength, args)

    def destroy(self, *args):
        return self._obj.invoke("destroy", _0_managedElement.ManagedElementIterator_I._d_destroy, args)
