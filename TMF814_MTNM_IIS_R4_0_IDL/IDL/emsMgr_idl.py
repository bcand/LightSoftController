...
EMSMgr_I._d_getHistoryAlarmDataByPull = ((omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NamingAttributesList_T:1.0"], (omniORB.tcInternal.tv_string,0), (omniORB.tcInternal.tv_string,0), (omniORB.tcInternal.tv_string,0), omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/Time_T:1.0"], omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/Time_T:1.0"], omniORB.typeMapping["IDL:mtnm.tmforum.org/notifications/ProbableCauseList_T:1.0"], omniORB.typeMapping["IDL:mtnm.tmforum.org/notifications/PerceivedSeverityList_T:1.0"]), (), {_0_globaldefs.ProcessingFailureException._NP_RepositoryId: _0_globaldefs._d_ProcessingFailureException})
...
class _objref_EMSMgr_I (_0_common._objref_Common_I):
    ...
    def getHistoryAlarmDataByPull(self, *args):
        return self._obj.invoke("getHistoryAlarmDataByPull", _0_emsMgr.EMSMgr_I._d_getHistoryAlarmDataByPull, args)
