...
class _objref_EmsSession_I (_0_session._objref_Session_I):
    ...
    def getSupportedManagers(self, *args):
        return self._obj.invoke("getSupportedManagers", _0_emsSession.EmsSession_I._d_getSupportedManagers, args)

    def getManager(self, *args):
        return self._obj.invoke("getManager", _0_emsSession.EmsSession_I._d_getManager, args)

    def getEventChannel(self, *args):
        return self._obj.invoke("getEventChannel", _0_emsSession.EmsSession_I._d_getEventChannel, args)
