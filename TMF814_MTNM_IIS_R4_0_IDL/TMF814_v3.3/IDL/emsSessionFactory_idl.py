...
class _objref_EmsSessionFactory_I (_0_mtnmVersion._objref_Version_I):
    ...
    def __init__(self, obj):
        _0_mtnmVersion._objref_Version_I.__init__(self, obj)

    def getEmsSession(self, *args):
        return self._obj.invoke("getEmsSession", _0_emsSessionFactory.EmsSessionFactory_I._d_getEmsSession, args)
