...
# struct GTP_T
_0_terminationPoint.GTP_T = omniORB.newEmptyClass()
class GTP_T (omniORB.StructBase):
    _NP_RepositoryId = "IDL:mtnm.tmforum.org/terminationPoint/GTP_T:1.0"

    def __init__(self, name, userLabel, nativeEMSName, owner, alarmReportingIndicator, listOfTPs, gtpConnectionState, additionalInfo):
        self.name = name
        self.userLabel = userLabel
        self.nativeEMSName = nativeEMSName
        self.owner = owner
        self.alarmReportingIndicator = alarmReportingIndicator
        self.listOfTPs = listOfTPs
        self.gtpConnectionState = gtpConnectionState
        self.additionalInfo = additionalInfo

_0_terminationPoint.GTP_T = GTP_T
_0_terminationPoint._d_GTP_T  = (omniORB.tcInternal.tv_struct, GTP_T, GTP_T._NP_RepositoryId, "GTP_T", "name", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NamingAttributes_T:1.0"], "userLabel", (omniORB.tcInternal.tv_string,0), "nativeEMSName", (omniORB.tcInternal.tv_string,0), "owner", (omniORB.tcInternal.tv_string,0), "alarmReportingIndicator", omniORB.tcInternal.tv_boolean, "listOfTPs", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NamingAttributesList_T:1.0"], "gtpConnectionState", omniORB.typeMapping["IDL:mtnm.tmforum.org/terminationPoint/TPConnectionState_T:1.0"], "additionalInfo", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NVSList_T:1.0"])
_0_terminationPoint._tc_GTP_T = omniORB.tcInternal.createTypeCode(_0_terminationPoint._d_GTP_T)
omniORB.registerType(GTP_T._NP_RepositoryId, _0_terminationPoint._d_GTP_T, _0_terminationPoint._tc_GTP_T)
del GTP_T

# typedef ... GTPlist_T
class GTPlist_T:
    _NP_RepositoryId = "IDL:mtnm.tmforum.org/terminationPoint/GTPlist_T:1.0"
    def __init__(self, *args, **kw):
        raise RuntimeError("Cannot construct objects of this type.")
_0_terminationPoint.GTPlist_T = GTPlist_T
_0_terminationPoint._d_GTPlist_T  = (omniORB.tcInternal.tv_sequence, omniORB.typeMapping["IDL:mtnm.tmforum.org/terminationPoint/GTP_T:1.0"], 0)
_0_terminationPoint._ad_GTPlist_T = (omniORB.tcInternal.tv_alias, GTPlist_T._NP_RepositoryId, "GTPlist_T", (omniORB.tcInternal.tv_sequence, omniORB.typeMapping["IDL:mtnm.tmforum.org/terminationPoint/GTP_T:1.0"], 0))
_0_terminationPoint._tc_GTPlist_T = omniORB.tcInternal.createTypeCode(_0_terminationPoint._ad_GTPlist_T)
omniORB.registerType(GTPlist_T._NP_RepositoryId, _0_terminationPoint._ad_GTPlist_T, _0_terminationPoint._tc_GTPlist_T)
del GTPlist_T

# enum GTPEffort_T
_0_terminationPoint.EFFORT_WHATEVER = omniORB.EnumItem("EFFORT_WHATEVER", 0)
_0_terminationPoint.EFFORT_SAME = omniORB.EnumItem("EFFORT_SAME", 1)
_0_terminationPoint.GTPEffort_T = omniORB.Enum("IDL:mtnm.tmforum.org/terminationPoint/GTPEffort_T:1.0", (_0_terminationPoint.EFFORT_WHATEVER, _0_terminationPoint.EFFORT_SAME,))

_0_terminationPoint._d_GTPEffort_T  = (omniORB.tcInternal.tv_enum, _0_terminationPoint.GTPEffort_T._NP_RepositoryId, "GTPEffort_T", _0_terminationPoint.GTPEffort_T._items)
_0_terminationPoint._tc_GTPEffort_T = omniORB.tcInternal.createTypeCode(_0_terminationPoint._d_GTPEffort_T)
omniORB.registerType(_0_terminationPoint.GTPEffort_T._NP_RepositoryId, _0_terminationPoint._d_GTPEffort_T, _0_terminationPoint._tc_GTPEffort_T)
...
class _objref_TerminationPointIterator_I (CORBA.Object):
    ...
    def next_n(self, *args):
        return self._obj.invoke("next_n", _0_terminationPoint.TerminationPointIterator_I._d_next_n, args)

    def getLength(self, *args):
        return self._obj.invoke("getLength", _0_terminationPoint.TerminationPointIterator_I._d_getLength, args)

    def destroy(self, *args):
        return self._obj.invoke("destroy", _0_terminationPoint.TerminationPointIterator_I._d_destroy, args)
...
_0_terminationPoint._d_GTPiterator_I = (omniORB.tcInternal.tv_objref, "IDL:mtnm.tmforum.org/terminationPoint/GTPiterator_I:1.0", "GTPiterator_I")
omniORB.typeMapping["IDL:mtnm.tmforum.org/terminationPoint/GTPiterator_I:1.0"] = _0_terminationPoint._d_GTPiterator_I
...
_0_terminationPoint.GTPiterator_I = GTPiterator_I
_0_terminationPoint._tc_GTPiterator_I = omniORB.tcInternal.createTypeCode(_0_terminationPoint._d_GTPiterator_I)
omniORB.registerType(GTPiterator_I._NP_RepositoryId, _0_terminationPoint._d_GTPiterator_I, _0_terminationPoint._tc_GTPiterator_I)

# GTPiterator_I operations and attributes
GTPiterator_I._d_next_n = ((omniORB.tcInternal.tv_ulong, ), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping["IDL:mtnm.tmforum.org/terminationPoint/GTPlist_T:1.0"]), {_0_globaldefs.ProcessingFailureException._NP_RepositoryId: _0_globaldefs._d_ProcessingFailureException})
GTPiterator_I._d_getLength = ((), (omniORB.tcInternal.tv_ulong, ), {_0_globaldefs.ProcessingFailureException._NP_RepositoryId: _0_globaldefs._d_ProcessingFailureException})
GTPiterator_I._d_destroy = ((), (), {_0_globaldefs.ProcessingFailureException._NP_RepositoryId: _0_globaldefs._d_ProcessingFailureException})

# GTPiterator_I object reference
class _objref_GTPiterator_I (CORBA.Object):
    _NP_RepositoryId = GTPiterator_I._NP_RepositoryId

    def __init__(self, obj):
        CORBA.Object.__init__(self, obj)

    def next_n(self, *args):
        return self._obj.invoke("next_n", _0_terminationPoint.GTPiterator_I._d_next_n, args)

    def getLength(self, *args):
        return self._obj.invoke("getLength", _0_terminationPoint.GTPiterator_I._d_getLength, args)

    def destroy(self, *args):
        return self._obj.invoke("destroy", _0_terminationPoint.GTPiterator_I._d_destroy, args)

omniORB.registerObjref(GTPiterator_I._NP_RepositoryId, _objref_GTPiterator_I)
_0_terminationPoint._objref_GTPiterator_I = _objref_GTPiterator_I
del GTPiterator_I, _objref_GTPiterator_I

# GTPiterator_I skeleton
__name__ = "terminationPoint__POA"
class GTPiterator_I (PortableServer.Servant):
    _NP_RepositoryId = _0_terminationPoint.GTPiterator_I._NP_RepositoryId


    _omni_op_d = {"next_n": _0_terminationPoint.GTPiterator_I._d_next_n, "getLength": _0_terminationPoint.GTPiterator_I._d_getLength, "destroy": _0_terminationPoint.GTPiterator_I._d_destroy}

GTPiterator_I._omni_skeleton = GTPiterator_I
_0_terminationPoint__POA.GTPiterator_I = GTPiterator_I
omniORB.registerSkeleton(GTPiterator_I._NP_RepositoryId, GTPiterator_I)
del GTPiterator_I
__name__ = "terminationPoint"
