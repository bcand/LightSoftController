...
_0_subnetworkConnection.RouteCreateData_T = omniORB.newEmptyClass()
class RouteCreateData_T (omniORB.StructBase):
    _NP_RepositoryId = "IDL:mtnm.tmforum.org/subnetworkConnection/RouteCreateData_T:1.0"

    def __init__(self, intended, exclusive, ccInclusions, neTpInclusions, fullRoute, neTpSncExclusions, additionalCreationInfo):
        self.intended = intended
        self.exclusive = exclusive
...
_0_subnetworkConnection.RouteCreateData_T = RouteCreateData_T
_0_subnetworkConnection._d_RouteCreateData_T  = (omniORB.tcInternal.tv_struct, RouteCreateData_T, RouteCreateData_T._NP_RepositoryId, "RouteCreateData_T", "intended", (omniORB.tcInternal.tv_string,0), "exclusive", (omniORB.tcInternal.tv_string,0), "ccInclusions", omniORB.typeMapping["IDL:mtnm.tmforum.org/subnetworkConnection/CrossConnectList_T:1.0"], "neTpInclusions", omniORB.typeMapping["IDL:mtnm.tmforum.org/subnetworkConnection/ResourceList_T:1.0"], "fullRoute", omniORB.tcInternal.tv_boolean, "neTpSncExclusions", omniORB.typeMapping["IDL:mtnm.tmforum.org/subnetworkConnection/ResourceList_T:1.0"], "additionalCreationInfo", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NVSList_T:1.0"])
_0_subnetworkConnection._tc_RouteCreateData_T = omniORB.tcInternal.createTypeCode(_0_subnetworkConnection._d_RouteCreateData_T)
omniORB.registerType(RouteCreateData_T._NP_RepositoryId, _0_subnetworkConnection._d_RouteCreateData_T, _0_subnetworkConnection._tc_RouteCreateData_T)
del RouteCreateData_T

# struct RouteNameAndAdminState_T
_0_subnetworkConnection.RouteNameAndAdminState_T = omniORB.newEmptyClass()
class RouteNameAndAdminState_T (omniORB.StructBase):
    _NP_RepositoryId = "IDL:mtnm.tmforum.org/subnetworkConnection/RouteNameAndAdminState_T:1.0"

    def __init__(self, id, administrativeState, additionalInfo):
        self.id = id
        self.administrativeState = administrativeState
        self.additionalInfo = additionalInfo

_0_subnetworkConnection.RouteNameAndAdminState_T = RouteNameAndAdminState_T
_0_subnetworkConnection._d_RouteNameAndAdminState_T  = (omniORB.tcInternal.tv_struct, RouteNameAndAdminState_T, RouteNameAndAdminState_T._NP_RepositoryId, "RouteNameAndAdminState_T", "id", (omniORB.tcInternal.tv_string,0), "administrativeState", (omniORB.tcInternal.tv_string,0), "additionalInfo", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NVSList_T:1.0"])
_0_subnetworkConnection._tc_RouteNameAndAdminState_T = omniORB.tcInternal.createTypeCode(_0_subnetworkConnection._d_RouteNameAndAdminState_T)
omniORB.registerType(RouteNameAndAdminState_T._NP_RepositoryId, _0_subnetworkConnection._d_RouteNameAndAdminState_T, _0_subnetworkConnection._tc_RouteNameAndAdminState_T)
del RouteNameAndAdminState_T

# typedef ... RouteNameAndAdminStateList_T
class RouteNameAndAdminStateList_T:
    _NP_RepositoryId = "IDL:mtnm.tmforum.org/subnetworkConnection/RouteNameAndAdminStateList_T:1.0"
    def __init__(self, *args, **kw):
        raise RuntimeError("Cannot construct objects of this type.")
_0_subnetworkConnection.RouteNameAndAdminStateList_T = RouteNameAndAdminStateList_T
_0_subnetworkConnection._d_RouteNameAndAdminStateList_T  = (omniORB.tcInternal.tv_sequence, omniORB.typeMapping["IDL:mtnm.tmforum.org/subnetworkConnection/RouteNameAndAdminState_T:1.0"], 0)
_0_subnetworkConnection._ad_RouteNameAndAdminStateList_T = (omniORB.tcInternal.tv_alias, RouteNameAndAdminStateList_T._NP_RepositoryId, "RouteNameAndAdminStateList_T", (omniORB.tcInternal.tv_sequence, omniORB.typeMapping["IDL:mtnm.tmforum.org/subnetworkConnection/RouteNameAndAdminState_T:1.0"], 0))
_0_subnetworkConnection._tc_RouteNameAndAdminStateList_T = omniORB.tcInternal.createTypeCode(_0_subnetworkConnection._ad_RouteNameAndAdminStateList_T)
omniORB.registerType(RouteNameAndAdminStateList_T._NP_RepositoryId, _0_subnetworkConnection._ad_RouteNameAndAdminStateList_T, _0_subnetworkConnection._tc_RouteNameAndAdminStateList_T)
del RouteNameAndAdminStateList_T
...
class _objref_CCIterator_I (CORBA.Object):
    ...
    def next_n(self, *args):
        return self._obj.invoke("next_n", _0_subnetworkConnection.CCIterator_I._d_next_n, args)

    def getLength(self, *args):
        return self._obj.invoke("getLength", _0_subnetworkConnection.CCIterator_I._d_getLength, args)

    def destroy(self, *args):
        return self._obj.invoke("destroy", _0_subnetworkConnection.CCIterator_I._d_destroy, args)
...
class _objref_SNCIterator_I (CORBA.Object):
    ...
    def next_n(self, *args):
        return self._obj.invoke("next_n", _0_subnetworkConnection.SNCIterator_I._d_next_n, args)

    def getLength(self, *args):
        return self._obj.invoke("getLength", _0_subnetworkConnection.SNCIterator_I._d_getLength, args)

    def destroy(self, *args):
        return self._obj.invoke("destroy", _0_subnetworkConnection.SNCIterator_I._d_destroy, args)
