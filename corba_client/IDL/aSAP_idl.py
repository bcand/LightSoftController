...
class _objref_ASAPIterator_I (CORBA.Object):
    ...
    def next_n(self, *args):
        return _omnipy.invoke(self, "next_n", _0_aSAP.ASAPIterator_I._d_next_n, args)

    def getLength(self, *args):
        return _omnipy.invoke(self, "getLength", _0_aSAP.ASAPIterator_I._d_getLength, args)

    def destroy(self, *args):
        return _omnipy.invoke(self, "destroy", _0_aSAP.ASAPIterator_I._d_destroy, args)
