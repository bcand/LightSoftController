# Python stubs generated by omniidl from CosEventComm.idl
...
_0_CosEventComm = omniORB.openModule("CosEventComm", r"CosEventComm.idl")
_0_CosEventComm__POA = omniORB.openModule("CosEventComm__POA", r"CosEventComm.idl")
