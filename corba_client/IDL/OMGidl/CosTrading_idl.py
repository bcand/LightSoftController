# Python stubs generated by omniidl from CosTrading.idl
...
#
__name__ = "CosTrading"
_0_CosTrading = omniORB.openModule("CosTrading", r"CosTrading.idl")
_0_CosTrading__POA = omniORB.openModule("CosTrading__POA", r"CosTrading.idl")
...
class Lookup (_0_CosTrading.TraderComponents, _0_CosTrading.SupportAttributes, _0_CosTrading.ImportAttributes):
    ...
    SpecifiedProps._m_to_d = {"prop_names": some, "none_dummy": none, "all_dummy": all}
    SpecifiedProps._d_to_m = {some: "prop_names", none: "none_dummy", all: "all_dummy"}
    SpecifiedProps._def_m  = None
    SpecifiedProps._def_d  = None

    _m_SpecifiedProps  = ((some, "prop_names", omniORB.typeMapping["IDL:omg.org/CosTrading/PropertyNameSeq:1.0"]), (none, "none_dummy", omniORB.tcInternal.tv_short), (all, "all_dummy", omniORB.tcInternal.tv_short),)
    _d_SpecifiedProps  = _0_CosTrading.Lookup._d_SpecifiedProps = (omniORB.tcInternal.tv_union, SpecifiedProps, SpecifiedProps._NP_RepositoryId, "SpecifiedProps", omniORB.typeMapping["IDL:omg.org/CosTrading/Lookup/HowManyProps:1.0"], -1, _m_SpecifiedProps, None, {some: _m_SpecifiedProps[0], none: _m_SpecifiedProps[1], all: _m_SpecifiedProps[2]})
