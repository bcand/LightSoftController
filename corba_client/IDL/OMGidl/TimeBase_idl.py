# Python stubs generated by omniidl from TimeBase.idl
...
#
__name__ = "TimeBase"
_0_TimeBase = omniORB.openModule("TimeBase", r"TimeBase.idl")
_0_TimeBase__POA = omniORB.openModule("TimeBase__POA", r"TimeBase.idl")
