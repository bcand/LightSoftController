...
_0_topologicalLink.TLCreateData_T = omniORB.newEmptyClass()
class TLCreateData_T (omniORB.StructBase):
    _NP_RepositoryId = "IDL:mtnm.tmforum.org/topologicalLink/TLCreateData_T:1.0"

    def __init__(self, userLabel, forceUniqueness, owner, direction, rate, aEndTP, zEndTP, additionalCreationInfo):
        self.userLabel = userLabel
...
_0_topologicalLink.TLCreateData_T = TLCreateData_T
_0_topologicalLink._d_TLCreateData_T  = (omniORB.tcInternal.tv_struct, TLCreateData_T, TLCreateData_T._NP_RepositoryId, "TLCreateData_T", "userLabel", (omniORB.tcInternal.tv_string,0), "forceUniqueness", omniORB.tcInternal.tv_boolean, "owner", (omniORB.tcInternal.tv_string,0), "direction", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/ConnectionDirection_T:1.0"], "rate", omniORB.typeMapping["IDL:mtnm.tmforum.org/transmissionParameters/LayerRate_T:1.0"], "aEndTP", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NamingAttributes_T:1.0"], "zEndTP", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NamingAttributes_T:1.0"], "additionalCreationInfo", omniORB.typeMapping["IDL:mtnm.tmforum.org/globaldefs/NVSList_T:1.0"])
_0_topologicalLink._tc_TLCreateData_T = omniORB.tcInternal.createTypeCode(_0_topologicalLink._d_TLCreateData_T)
omniORB.registerType(TLCreateData_T._NP_RepositoryId, _0_topologicalLink._d_TLCreateData_T, _0_topologicalLink._tc_TLCreateData_T)
del TLCreateData_T
...
class _objref_TopologicalLinkIterator_I (CORBA.Object):
    ...
    def next_n(self, *args):
        return self._obj.invoke("next_n", _0_topologicalLink.TopologicalLinkIterator_I._d_next_n, args)

    def getLength(self, *args):
        return self._obj.invoke("getLength", _0_topologicalLink.TopologicalLinkIterator_I._d_getLength, args)

    def destroy(self, *args):
        return self._obj.invoke("destroy", _0_topologicalLink.TopologicalLinkIterator_I._d_destroy, args)
